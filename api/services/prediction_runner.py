        ...
        for match in matches:
            try:
                ...
                payload = {
                    ...
                    "engine_used": result.get('model_version', 'unknown'),
                    
                    "p_serve_p1": p_serve_p1,
                    "p_serve_p2": p_serve_p2,
                    ...
                    "avg_total_games": avg_games,
                    
                    "surface": match.get('surface'),
                    "tournament": match.get('tournament'),
                    
                    # Trust fields (Commented out due to Schema Cache issues)
                ...
                res_ins = self.db.from_('predictions').insert(payload).execute()
                if res_ins.error:
